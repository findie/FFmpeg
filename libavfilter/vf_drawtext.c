...
static const AVOption drawtext_options[]= {
    ...
    {"offsetx",     "set offsetx expression", OFFSET(offsetx_expr),     AV_OPT_TYPE_STRING, {.str="0"},   0, 0, FLAGS},
    {"offsety",     "set offsety expression", OFFSET(offsety_expr),     AV_OPT_TYPE_STRING, {.str="0"},   0, 0, FLAGS},
